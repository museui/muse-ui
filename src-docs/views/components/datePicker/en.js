...
export default {
  ...
  simpleExampleDesc: 'the default popup box direction is the  vertical. you can swith the direction between the  vertical mode and horizontal mode by configing the `mode` attibute.',
  ...
  disabledExample: 'we also can assign the function to determin what the range date should not be selected',
  disabledExampleDesc: '`shouldDisableDate` parameter is used to determin what is the range date should not be selectd by the specific function',
  ...
  props: {
    ...
    shouldDisableDate: 'to determin the disable date with function',
    ...
    label: 'the lable of date picker',
    ...
    disabled: 'whther the date picker is disabled or not',
    hintText: 'hint text',
