...
export default {
  ...
  props: {
    autoOk: 'whther it is completed automatically or not after you choose the minute, if it is true, the `ok` button is disappear.',
    ...
    label: 'the lable of time picker',
    labelFloat: 'whether the label can be float',
    labelClass: 'style of label, the binding way is same with `class`',
    labelFocusClass: 'the style of lable when the input box is focusing, the binding way is same with `class`',
    disabled: 'whther the time picker is disabled or not',
    hintText: 'hint text',
