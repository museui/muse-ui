...
| min-col-width | minimum width of each table | Number | — | 128 |
...
| checkbox-col-width | checkbox's width | Number | — | 75 |
...
| expand-row-index | the index value of the expand row, support `.sync` | Number | — | -1 |
| auto-expand | whether to click on the table row to expand automatically | Boolean | — | true |
